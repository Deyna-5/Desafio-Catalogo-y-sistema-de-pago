...
ActiveRecord::Schema.define(version: 2021_04_21_225643) do
  ...
  create_table "transbacks", force: :cascade do |t|
    t.string "amount"
    t.string "method_type"
    t.integer "method_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["method_type", "method_id"], name: "index_transbacks_on_method_type_and_method_id"
  end
